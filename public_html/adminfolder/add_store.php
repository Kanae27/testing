        ...
        <div class="right_col" role="main">
          ...
          <br />
              ...
              <div class="col-md-6 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Fill up all fields to add store</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
					...
					$message = 'Administrator add a store';
					$date = date('F d, Y h:i A');
					$username = $username;
				$save = $conn->query("INSERT INTO audit (action, timestamp,username)VALUES ('$message','$date','$username')");
						
$save = $conn->query("INSERT INTO store (store, location, officer,description,contact,username)VALUES ('$store', '$location','$officer', '$description','$contact','$username')");
$save1 = $conn->query("INSERT INTO login (username, password, type)VALUES ('$username', '$password', '$type')");
if($save) {
	echo '<script>alert("Store has been added");window.location="store.php"</script>';
}
$conn->close();
					}
					?>
                    <form class="form-horizontal form-label-left" action="#" method="POST">
                      ...
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Store Name</label>
                      ...
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Officer in Charge</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="password" class="form-control" name="password" required  pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$" title="Password must be minimum of 8 characters, 1 number and 1 special character">
                        </div>
                      </div>
