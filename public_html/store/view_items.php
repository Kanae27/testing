              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 " style="color:#000">
                  <div class="x_panel">
					...
					$result1 = $conn->query("SELECT * FROM cart WHERE status = 'Pending' AND username = '$user' AND invoice = '$invoice' ORDER BY username");
                    ...
                    <tr>
						...
						<input type="button" value="Approve Orders" onclick="window.location='approve.php?user=<?php echo $_GET['id'] ?>&invoice=<?php echo $invoice ?>&user1=<?php echo $_GET['id'] ?>'" class="btn btn-primary">
						<input type="button" value="Decline Orders" onclick="window.location='decline.php?user=<?php echo $_GET['id'] ?>'" class="btn btn-danger">
                      </div>
                    </div>
                  </div>
                </div>
