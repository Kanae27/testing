  ...
  <table id="customers" class="table table-striped table-bordered" style="width:100%">
					...
					$result = $conn->query("SELECT * FROM product ");
					  while($row = $result->fetch_assoc()) {
                        ...
                        echo '  <td><center><input type="button" value="View Product Transaction" class="btn btn-primary" onclick="window.location=\'view_transaction.php?id='.$row['id'].'&item='.$row['item'].'\'"><br><a style="margin:0px;margin-top:10px !important" href="delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this record?\')" class="btn btn-danger">Delete</a></td>';
                        echo '</tr>';
